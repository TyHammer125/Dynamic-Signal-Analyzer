% Project:        2.14 Demos
% Title:          1x Mass-Spring-Damper Demo
% Author:         Tyler Hamer
...
b2          = 0;                 % [N*s/m]  damping coefficient for damper 2
                                 %          set = 0 to disconnect masses
k1          = 1400;              % [N/m]    stiffness for spring 1
k2          = 0;                 % [N/m]    stiffness for spring 2
                                 %          set = 0 to disconnect masses
...
P.meas_data = xlsread('Mass_Spring_Damper_x1_2_14_Analysis.xlsx', 'A4:C361');
...
title({'1 Mass-Spring-Damper \& Voice Coil Freq. Response', ...
       '$K_{\rm dc}$ = 1.08, $\omega_{\rm N}$ = 6.3 Hz, $\zeta$ = 0.21, \& $f_{\rm s}$ = 2 kHz'})
...
Cntrl.meas_data = xlsread('Mass_Spring_Damper_x1_2_14_Analysis.xlsx', 'E4:G360');
...
RR.meas_data = xlsread('Mass_Spring_Damper_x1_2_14_Analysis.xlsx', 'I4:K360');
...
CL.meas_data = xlsread('Mass_Spring_Damper_x1_2_14_Analysis.xlsx', 'M4:O360');
